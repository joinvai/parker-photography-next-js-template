  ...
  return (
    ...
    >
      ...
      >
        ...
        {!quoteLoaded && (
          <div className="sr-only">Loading founder's quote</div>
        )}

        <blockquote className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light italic max-w-4xl mx-auto text-gray-800 transition-opacity duration-300"
          style={{ opacity: quoteLoaded ? 1 : 0 }}
          onLoad={() => setQuoteLoaded(true)}
        >
          <span className="block mb-2 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">"</span>
          <p>
            We believe that luxury is about creating spaces that tell your story.
            Each detail matters, each material chosen with purpose, and each room
      ...
      >
        ...
        >
          <Image
            ...
            alt="Gabriela Siere's signature - Founder of Sire Design"
            fill
