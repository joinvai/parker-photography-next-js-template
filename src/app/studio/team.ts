...
export const teamData: TeamMember[] = [
  {
    ...
    bio: `Eilyn Jimenez is an interior designer, TV personality, and visionary Founder and Creative Director of Miami-based interior design firm, Sire Design.

Eilyn is driven by a passion for the transformative power of design. With a nuanced understanding of how spaces influence emotions and well-being, Eilyn believes that our environments have the power to inspire, comfort, and energize their inhabitants, and has made it her mission to harness this ineffable power in service of her clients.

Her design philosophy revolves around creating spaces that are not only functionally efficient and aesthetically pleasing, but also profoundly personal, resonating with the unique emotional landscapes of her clients.
...
Eilyn's expertise and dedication have garnered significant recognition and success. She has managed many projects across the country, showcasing her versatility and international appeal in residential, developmental, and commercial projects alike.
